...
form do |f|
  f.inputs "CharRef" do
    ...
    f.input :on_leave, :as => :select, :collection =>
    [['Annual Leave','Annual Leave'],
    ['Sick Leave','Sick Leave'],
    ['No Pay Leave','No Pay Leave'],
    ['Paternal/Maternal Leave','Paternal/Maternal Leave'],
    ['Berievement Leave','Berievement Leave']],
     :include_blank => true, :label => "On Leave?"
  end
f.actions
end
