...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { age: @child.age, faculty_id: @child.faculty_id, name: @child.name, sex: @child.sex }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { age: @child.age, faculty_id: @child.faculty_id, name: @child.name, sex: @child.sex }
    assert_redirected_to child_path(assigns(:child))
  end
