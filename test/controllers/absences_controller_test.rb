...
class AbsencesControllerTest < ActionController::TestCase
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post :create, absence: { date_of_absence: @absence.date_of_absence, faculty_id: @absence.faculty_id }
    end
  ...
  test "should update absence" do
    patch :update, id: @absence, absence: { date_of_absence: @absence.date_of_absence, faculty_id: @absence.faculty_id }
    assert_redirected_to absence_path(assigns(:absence))
  end
